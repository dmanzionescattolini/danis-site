...
export default (params) => {
    ...
    return (
        <MDBContainer fluid
                      className={"h-100 d-flex flex-column justify-content-evenly align-items-evenly p-0 m-0"}>

            <div id={"banner-film"} className={"h-100"}  style={{backgroundImage:`url(${image})`}}>
                <MDBBtn onClick={toggleOpen} id="playbutton" className="play-btn" >
                        <svg enableBackground="new 0 0 141.73 141.73"
                             height="141.73px"
                             id="Warstwa_1"
                             version="1.1"
      ...
      <g>
        ...
        c0.391-0.391,0.391-1.023,0-1.414L65.893,55.983z"
                ...
                <MDBModal open={basicModal} setOpen={setBasicModal} >
                    <MDBModalDialog>
                        <MDBModalContent>
                           <video className={"w-100 h-100 p-0 m-0"} muted={false} controls onEnded={toggleOpen} src={clip}></video>
