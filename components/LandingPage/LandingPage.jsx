...
export default function LandingPage() {
  ...
  return (
    <div className="m-0 p-0 d-flex justify-content-center align-items-center vw-100 w-100 h-100 vh-100 bg-image " style={{backgroundImage:"url('https://pagina-mama.s3.amazonaws.com/assets2/daniel/desert.png')"}}>
